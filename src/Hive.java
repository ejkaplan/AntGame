...
public abstract class Hive {
	...
	public final static int sightDistance = 7;
	private Game game;
	private String name;
	...
	/**
	 * 
	 * @return A list of arrays of integers indicating the locations of all friendly
	 *         ants, in (row, column) format.
	 */
	...
	/**
	 * 
	 * @return A list of arrays of integers indicating the locations of all visible
	 *         enemies, in (row, column) format.
	 */
	...
	/**
	 * 
	 * @return The amount of food remaining in your reserve. This is the number of
	 *         ants you would be able to spawn if you stopped collecting food.
	 */
	...
	/**
	 * 
	 * @return A 2D array of booleans, where each sub-array represents a row of the
	 *         maze. True represents the presence of a wall, false represents
	 *         navigable space.
	 */
	...
	/**
	 * Gives orders for how all of your ants are supposed to move. You should return
	 * a String of the format "row col dir\nrow col dir\nrow col..." Each ant should
	 * have its own line of the orders. You specify the ant to move by specifying
	 * its position, and use one of the letters "n", "s", "e", or "w" to indicate
	 * direction. If you don't want an ant to move, just do not reference that ant
	 * in the orders.
	 * 
